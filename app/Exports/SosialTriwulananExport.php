...
class SosialTriwulananExport implements FromCollection, WithHeadings
{
    protected $dataRange;
    ...
    public function collection()
    {
        ...
        // Tentukan prefix berdasarkan jenis kegiatan (default 'Seruti')
        ...
        // Filter berdasarkan kegiatan spesifik (misal: Seruti-TW1, Seruti-TW2)
    ...
    {
        $templatePath = storage_path('templates/sosial_triwulanan_template.docx');
        ...
        $judulLaporan = 'Laporan Sosial Triwulanan (Seruti) Tahun ' . $this->tahun;
        if (!empty($this->kegiatan)) {
        ...
        $placeholderToClone = 'id_sosial_triwulanan';
        ...
        if ($dataCount > 0) {
            ...
            foreach ($data as $index => $row) {
                ...
                $templateProcessor->setValue('id_sosial_triwulanan#' . $i, $row->id_sosial_triwulanan ?? '');
            ...
            try {
                ...
                $templateProcessor->setValue('id_sosial_triwulanan#1', 'Tidak ada data');
