...
class SosialTahunanExport implements FromCollection, WithHeadings
{
    protected $dataRange;
    ...
    {
        $templatePath = storage_path('templates/sosial_tahunan_template.docx');
        ...
        $judulLaporan = 'Laporan Sosial Tahunan Tahun ' . $this->tahun;
        if (!empty($this->kegiatan)) {
        ...
        if ($dataCount > 0) {
            ...
            foreach ($data as $index => $row) {
                ...
                $templateProcessor->setValue('id_sosial#' . $i, $row->id_sosial ?? '');
            ...
            try {
                ...
                $templateProcessor->setValue('id_sosial#1', 'Tidak ada data');
