                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            @forelse ($listData ?? [] as $item)
                                <tr>
                                    <td><input type="checkbox" class="form-check-input row-checkbox" value="{{ $item->id_produksi_caturwulanan }}"></td>
                                    ...
                                    <td class="d-flex gap-2">
                                        <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editDataModal" onclick="editData({{ $item->id_produksi_caturwulanan }})"><i class="bi bi-pencil-square"></i></button>
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteDataModal" onclick="deleteData({{ $item->id_produksi_caturwulanan }})"><i class="bi bi-trash"></i></button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="tanggal_pengumpulan" class="form-label">Tanggal Pengumpulan <span class="text-danger">*</span></label> {{-- Required in controller --}}
            ...
            <form id="editForm" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                             <label for="edit_tanggal_pengumpulan" class="form-label">Tanggal Pengumpulan <span class="text-danger">*</span></label> {{-- Required in controller --}}
                            <input type="date" class="form-control @error('tanggal_pengumpulan') is-invalid @enderror" id="edit_tanggal_pengumpulan" name="tanggal_pengumpulan" required>
                            <div class="invalid-feedback" data-field="tanggal_pengumpulan">@error('tanggal_pengumpulan'){{ $message }}@enderror</div>
                        </div>
                    </div>
                    <div class="modal-footer">
...
<script>
    ...
    function editData(id) {
        ...
        editForm.action = `/tim-produksi/caturwulanan/${id}`; // <-- URL Caturwulanan
        clearFormErrors(editForm);
        fetch(`/tim-produksi/caturwulanan/${id}/edit`) // <-- URL Caturwulanan
    ...
    function deleteData(id) {
        ...
        deleteForm.action = `/tim-produksi/caturwulanan/${id}`; // <-- URL Caturwulanan
