        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="tanggal_pengumpulan" class="form-label">Tanggal Pengumpulan <span class="text-danger">*</span></label>
...
<script>
    ...
    function editData(id) {
        ...
        editForm.action = `/tim-produksi/caturwulanan/${id}`; 
        clearFormErrors(editForm);
        fetch(`/tim-produksi/caturwulanan/${id}/edit`) 
