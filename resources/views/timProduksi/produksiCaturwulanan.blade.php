                                ...
                                <td>
                                    ...
                                    @php
                                        ...
                                        if ($flag === 'Selesai') {
                                            ...
                                            $badgeClass = 'badge-danger'; // Gunakan danger untuk 'Belum Mulai'
                                        }
                                    @endphp
                            ...
                            <tr>
                                <td colspan="9" class="empty-state">
                                    ...
                                    @if(request('search') || request('kegiatan'))
                                        <a href="{{ route('tim-produksi.caturwulanan.index', ['jenisKegiatan' => $jenisKegiatan, 'tahun' => $selectedTahun ?? date('Y')]) }}"
            ...
            <div class="modal-content">
                <form action="{{ route('tim-produksi.caturwulanan.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- Download template -->
                        <div class="mb-3">
                            <a href="{{ route('tim-produksi.caturwulanan.downloadTemplate') }}" class="btn btn-sm btn-secondary">
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content">
                            <h5 class="modal-title">Ekspor Data Caturwulanan</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="exportDataRange" class="form-label">Jangkauan Data</label> {{-- Unique ID --}}
                            <select class="form-select" id="exportDataRange" name="dataRange" required>
                                <option value="all">Semua Catatan</option>
                                <option value="current_page">Hanya Halaman Terkini</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="exportDataFormat" class="form-label">Format Data</label> {{-- Unique ID --}}
                            <select class="form-select" id="exportDataFormat" name="dataFormat" required>
                                <option value="formatted_values">Formatted Values</option>
                                <option value="raw_values">Raw Values</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="exportExportFormat" class="form-label">Format Keluaran</label> {{-- Unique ID --}}
                            <select class="form-select" id="exportExportFormat" name="exportFormat" required>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered"> {{-- Gunakan modal-lg --}}
            <form action="{{ route('tim-produksi.caturwulanan.store') }}" method="POST" id="tambahForm">
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content">
                            <h5 class="modal-title">Tambah Data Caturwulanan</h5>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered"> {{-- Gunakan modal-lg --}}
            <form id="editForm" method="POST">
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content">
                            <h5 class="modal-title">Edit Data Caturwulanan</h5>
                    ...
                    <div class="modal-body">
                        <div class="modal-grid-2col"> {{-- Gunakan grid 2 kolom --}}
                            <div class="modal-column"> {{-- Kolom 1 --}}
                                <div class="form-group autocomplete-container">
