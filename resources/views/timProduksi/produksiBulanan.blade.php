                            ...
                            @forelse ($listData ?? [] as $item)
                                <tr>
                                    <td><input type="checkbox" class="form-check-input row-checkbox"
                                            value="{{ $item->id_produksi_bulanan }}"></td>
                                    ...
                                    <td class="d-flex gap-2">
                                        <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                            ...
                                            onclick="editData({{ $item->id_produksi_bulanan }})"><i
                                                class="bi bi-pencil-square"></i></button>
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#deleteDataModal"
                                            onclick="deleteData({{ $item->id_produksi_bulanan }})"><i
    ...
    <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('tim-produksi.bulanan.export', ['jenisKegiatan' => $jenisKegiatan]) }}"
                    method="GET">
                    @csrf
                    <input type="hidden" name="kegiatan" value="{{ request('kegiatan') }}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('flag_progress') is-invalid @enderror" id="flag_progress"
                                ...
                                <option value="Belum Selesai"
                                    {{ old('flag_progress') == 'Belum Selesai' ? 'selected' : '' }}>Belum
                                    Selesai</option>
                        ...
                        <div class="mb-3">
                            ...
                            <label for="tanggal_pengumpulan" class="form-label">Tanggal
                                Pengumpulan</label>
            ...
            <form id="editForm" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        {{-- Target Penyelesaian --}}
                        <div class="mb-3">
                            <label for="edit_target_penyelesaian" class="form-label">Tanggal Target
