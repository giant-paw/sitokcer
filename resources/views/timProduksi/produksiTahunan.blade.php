    ...
    {{-- Alert Import Errors --}}
        ...
        <div class="page-header mb-4">
            <div class="header-content">
                ...
                <p class="page-subtitle">Kelola data target kegiatan tahunan tim Produksi</p>
            </div>
        </div>
        ...
        <div class="data-card">
            ...
            <div class="toolbar">
                ...
                <div class="toolbar-right">
                    ...
                    <form action="{{ route('tim-produksi.tahunan.index') }}" method="GET" class="search-form">
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="empty-state">
                                    ...
                                    @if($search || $selectedKegiatan) <a href="{{ route('tim-produksi.tahunan.index') }}" class="empty-link">Reset filter</a> @endif
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="modal fade" id="tambahDataModal" tabindex="-1" aria-labelledby="tambahDataModalLabel" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-lg modal-dialog-centered"> 
            <form action="{{ route('tim-produksi.tahunan.store') }}" method="POST" id="tambahForm">
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content"> <h5 class="modal-title">Tambah Data Tahunan Baru</h5> <p class="modal-subtitle">Isi form di bawah</p> </div>
                        <button type="button" class="modal-close" data-bs-dismiss="modal" aria-label="Close"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group autocomplete-container">
                            ...
                            <input type="text" class="form-input @error('nama_kegiatan') is-invalid @enderror"
                                ...
                                placeholder="Ketik nama kegiatan..." required autocomplete="off">
...
{{-- 
====================================================================
== JAVASCRIPT INI SUDAH DISESUAIKAN UNTUK 'tahunan' (TANPA 'jenisKegiatan')
====================================================================
--}}
<script>
    /**
    ...
    // --- URL Basis ---
    const tahunanRootUrl = `{{ route('tim-produksi.tahunan.index') }}`; // URL dasar: .../tahunan
    ...
    function editData(id) {
        ...
        editForm.action = `${tahunanRootUrl}/${id}`; // Hasil: .../tahunan/123
        ...
        fetch(`${tahunanRootUrl}/${id}/edit`) // Hasil: .../tahunan/123/edit
            .then(response => { 
    ...
    function deleteData(id) {
        ...
        deleteForm.action = `${tahunanRootUrl}/${id}`; // Hasil: .../tahunan/123
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @if(Route::has('tim-produksi.tahunan.searchKegiatan'))
            // $jenisKegiatan tidak ada lagi, jadi kita hapus
            const kegiatanSearchUrl = `{{ route("tim-produksi.tahunan.searchKegiatan") }}?`; 
