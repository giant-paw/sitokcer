                            ...
                            @forelse ($listData ?? [] as $item)
                                <tr>
                                    <td><input type="checkbox" class="form-check-input row-checkbox"
                                            value="{{ $item->id_produksi_triwulanan }}"></td>
                                    ...
                                    <td class="d-flex gap-2">
                                        <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                            ...
                                            onclick="editData({{ $item->id_produksi_triwulanan }})"><i
                                                class="bi bi-pencil-square"></i></button>
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#deleteDataModal"
                                            onclick="deleteData({{ $item->id_produksi_triwulanan }})"><i
    ...
    <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('tim-produksi.triwulanan.export', ['jenisKegiatan' => $jenisKegiatan]) }}"
                    method="GET">
                    @csrf
                    <input type="hidden" name="kegiatan" value="{{ request('kegiatan') }}">
    ...
    <div class="modal fade" id="tambahDataModal" tabindex="-1" aria-labelledby="tambahDataModalLabel"
        ...
        <div class="modal-dialog">
            <form action="{{ route('tim-produksi.triwulanan.store') }}" method="POST" id="tambahForm">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Data Baru</h5> <button type="button" class="btn-close"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_pengumpulan') is-invalid @enderror"
                                ...
                                value="{{ old('tanggal_pengumpulan') }}"> {{-- Hapus 'required' jika nullable --}}
