...
@section('title', strtoupper($jenisKegiatan) . ' - Produksi Triwulanan - Sitokcer') {{-- Title disesuaikan --}}
    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div class="page-header mb-4">
            <div class="header-content">
                <h2 class="page-title">List Target Survei {{ ucwords($jenisKegiatan) }} (Triwulanan)</h2> {{-- Tambah keterangan Triwulanan --}}
        ...
        <div class="data-card">
            ...
            <div class="toolbar">
                ...
                <div class="toolbar-right">
                    ...
                    <form action="{{ route('tim-produksi.triwulanan.index', ['jenisKegiatan' => $jenisKegiatan]) }}"
                        ...
                        @forelse ($listData ?? [] as $item)
                                    <tr>
                                        <td class="td-checkbox"><input type="checkbox" class="table-checkbox row-checkbox"
                                                value="{{ $item->id_produksi_triwulanan }}"></td> {{-- ID Triwulanan --}}
                                        ...
                                        <td>
                                            @php
                                               ...
                                               $badgeClass = ($flag === 'Selesai') ? 'badge-success' : 'badge-warning'; // Selesai/Belum Selesai
                                            @endphp
                                        ...
                                        <td class="td-action">
                                            <div class="action-buttons">
                                                <button class="btn-icon btn-icon-edit" title="Edit" data-bs-toggle="modal"
                                                    ...
                                                    onclick="editData({{ $item->id_produksi_triwulanan }})"> {{-- ID Triwulanan --}}
                                                ...
                                                <button class="btn-icon btn-icon-delete" title="Hapus" data-bs-toggle="modal"
                                                    ...
                                                    onclick="deleteData({{ $item->id_produksi_triwulanan }})"> {{-- ID Triwulanan --}}
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round">
                                                        <polyline points="3 6 5 6 21 6"></polyline>
                            ...
                            <tr>
                                <td colspan="9" class="empty-state">
                                    ...
                                    @if(request('search') || request('kegiatan'))
                                        <a href="{{ route('tim-produksi.triwulanan.index', ['jenisKegiatan' => $jenisKegiatan, 'tahun' => $selectedTahun ?? date('Y')]) }}"
            ...
            <div class="modal-content">
                <form action="{{ route('tim-produksi.triwulanan.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <a href="{{ route('tim-produksi.triwulanan.downloadTemplate') }}" class="btn btn-sm btn-secondary">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('tim-produksi.triwulanan.export',['jenisKegiatan' => $jenisKegiatan] ) }}" method="GET" id="exportForm">
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content"> <h5 class="modal-title">Ekspor Data Produksi Triwulanan</h5> <p class="modal-subtitle">Pilih opsi ekspor Anda</p> </div>
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content">
                            <h5 class="modal-title">Tambah Data Triwulanan</h5>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered"> {{-- Gunakan modal-lg --}}
            <form id="editForm" method="POST">
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content">
                            <h5 class="modal-title">Edit Data Triwulanan</h5>
