...
{{-- Sesuaikan Title --}}
@section('title', strtoupper($jenisKegiatan) . ' - Produksi Triwulanan - Sitokcer')
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ empty(request('kegiatan')) ? 'active' : '' }}"
                           href="{{ route('tim-produksi.triwulanan.index', ['jenisKegiatan' => $jenisKegiatan, 'tahun' => $selectedTahun ?? date('Y')]) }}">
                            All <span class="badge bg-secondary">{{ collect($kegiatanCounts ?? [])->sum('total') }}</span>
                        </a>
                    </li>
                ...
                <form action="{{ route('tim-produksi.triwulanan.index', ['jenisKegiatan' => $jenisKegiatan]) }}" method="GET" class="mb-4">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            @forelse ($listData ?? [] as $item)
                                <tr>
                                    <td><input type="checkbox" class="form-check-input row-checkbox" value="{{ $item->id_produksi_triwulanan }}"></td>
                                    ...
                                    <td class="d-flex gap-2">
                                        <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editDataModal" onclick="editData({{ $item->id_produksi_triwulanan }})"><i class="bi bi-pencil-square"></i></button>
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteDataModal" onclick="deleteData({{ $item->id_produksi_triwulanan }})"><i class="bi bi-trash"></i></button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_pengumpulan') is-invalid @enderror" id="tanggal_pengumpulan" name="tanggal_pengumpulan" value="{{ old('tanggal_pengumpulan') }}"> {{-- Hapus 'required' jika nullable --}}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_pengumpulan') is-invalid @enderror" id="edit_tanggal_pengumpulan" name="tanggal_pengumpulan"> {{-- Hapus 'required' jika nullable --}}
                            <div class="invalid-feedback" data-field="tanggal_pengumpulan">@error('tanggal_pengumpulan'){{ $message }}@enderror</div>
                        </div>
                    </div>
                    <div class="modal-footer">
