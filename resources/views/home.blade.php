                ...
                <div class="info-panel">
                    ...
                    <div class="info-content">
                        <div class="info-item">
                            ...
                            <div class="info-text">
                                <p>Daftarkan kegiatan baru <a href="https://docs.google.com/spreadsheets/d/1TViFcsTtvLnpI1BWE4O5E778SBiDbncSbf8a49CKxWs/edit?gid=0#gid=0" target="_blank" class="info-link">di sini</a>, lalu konfirmasi ke Tim IT</p>
                            </div>
                        </div>
                        <div class="info-item">
                            <span class="info-number">2</span>
                            <div class="info-text">
                                <p>Download <a href="https://drive.google.com/file/d/1J2CuyJrA9atzjpesEbJi8JZU7tQEyYGP/edit" target="_blank" class="info-link">manual penggunaan</a> SITOKCER</p>
                            </div>
                        </div>
                        <div class="info-item">
                            <span class="info-number">3</span>
                            <div class="info-text">
                                <p>Gunakan <a href="https://drive.google.com/uc?export=download&id=17uzCIz6mBaomfCNlyYKcA5AjcUCt29jZ" target="_blank" class="info-link">template Excel</a> untuk import data</p>
                            </div>
                        </div>
                        <div class="info-item">
                ...
                <div class="quick-access-panel">
                    ...
                    <div class="quick-grid">
                        <div class="quick-item">
                            ...
                            <span class="quick-label">SKGB Giling</span>
                        </div>
                        <div class="quick-item">
                            <span class="quick-icon">📜</span>
                            <span class="quick-label">SKGB Kering</span>
                        </div>
                        <div class="quick-item">
                            <span class="quick-icon">📅</span>
                        ...
                        <a href="{{ route('tim-produksi.caturwulanan.index', ['jenisKegiatan' => 'ubinan padi palawija']) }}" class="quick-item quick-item-link">
                            <span class="quick-icon">🌾</span>
