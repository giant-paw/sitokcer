...
@push('styles')
    <style>
        ...
        .data-table {
            table-layout: fixed;
            /* Ini 'memaksa' kolom untuk patuh pada lebar yang ditentukan */
            width: 100%;
        }
        ...
        .data-table th:nth-child(2) {
            ...
            width: 20%;
            /* Anda bisa sesuaikan persentasenya, misal 15% atau 25% */
        }
        ...
        <div class="data-card">
            ...
            <div class="toolbar">
                <div class="toolbar-left">
                    ...
                    <button type="button" class="btn-action btn-danger" id="bulkDeleteBtn" data-bs-toggle="modal"
                    ...
                    <form action="{{ route('master.kegiatan.index') }}" method="GET" class="search-form"
                        ...
                        <div>
                            ...
                            <select name="filter_tim" class="form-input" style="min-width: 200px;"
                                ...
                                <option value="Tim Distribusi" @selected(request('filter_tim') == 'Tim Distribusi')>Tim
                                    Distribusi</option>
                                <option value="Tim Produksi" @selected(request('filter_tim') == 'Tim Produksi')>Tim Produksi
                                </option>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-input @error('tim') is-invalid @enderror" id="tim" name="tim" required>
                                ...
                                <option value="Tim Distribusi" @selected(old('tim') == 'Tim Distribusi')>Tim Distribusi
                                </option>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="edit_nama_kegiatan" class="form-label">Nama Kegiatan <span
                                    class="required">*</span></label>
                            <input type="text" class="form-input @error('nama_kegiatan', 'edit_error') is-invalid @enderror"
                                id="edit_nama_kegiatan" name="nama_kegiatan" required>
                            @error('nama_kegiatan', 'edit_error') <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-input @error('deskripsi', 'edit_error') is-invalid @enderror"
