            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
                ...
                <div class="col-12 col-md-4 mt-2 mt-md-0">
                    <form action="{{ route('master.kegiatan.index') }}" method="GET" class="d-flex">
                        <input type="text" class="form-control me-1" name="search" value="{{ $search ?? '' }}" placeholder="Cari Nama/Deskripsi...">
                    ...
                    <table class="table table-striped table-bordered table-hover align-middle">
                        ...
                        <tbody>
                            @forelse ($kegiatan as $k)
                                <tr>
                                    <td class="text-center"><input type="checkbox" class="form-check-input row-checkbox" name="ids[]" value="{{ $k->id_master_kegiatan }}"></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_kegiatan') is-invalid @enderror" id="edit_nama_kegiatan" name="nama_kegiatan" required>
                        @error('nama_kegiatan') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
