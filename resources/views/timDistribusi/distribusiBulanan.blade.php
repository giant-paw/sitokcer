        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if ($errors->any() && !session('error_modal'))
                    {{-- Hanya tampilkan jika bukan error modal --}}
                ...
                <form action="{{ route('tim-distribusi.bulanan.index', ['jenisKegiatan' => $jenisKegiatan]) }}"
                            ...
                            @forelse ($listData as $item)
                                <tr>
                                    <td><input type="checkbox" class="form-check-input row-checkbox"
                                            value="{{ $item->id_distribusi_bulanan }}"></td>
                                    ...
                                    <td class="d-flex gap-2">
                                        <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                            ...
                                            onclick="editData({{ $item->id_distribusi_bulanan }})"><i
                                                class="bi bi-pencil-square"></i></button>
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#deleteDataModal"
                                            onclick="deleteData({{ $item->id_distribusi_bulanan }})"><i
            ...
            <form action="{{ route('tim-distribusi.bulanan.store') }}" method="POST" id="tambahForm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="target_penyelesaian" class="form-label">Tanggal Target Penyelesaian <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_pengumpulan') is-invalid @enderror"
                                ...
                                value="{{ old('tanggal_pengumpulan') }}" required>
