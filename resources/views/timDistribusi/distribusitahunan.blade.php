                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm">
                                            <button class="btn btn-warning" data-bs-toggle="modal"
                                                ...
                                                onclick="editData({{ $item->id_distribusi }})"><i
                                                    class="bi bi-pencil-square"></i></button>
                                            <button class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleteDataModal"
                                                onclick="deleteData({{ $item->id_distribusi }})"><i
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center">Tidak ada data yang ditemukan untuk tahun
                                        {{ $selectedTahun }}.</td>
                                </tr>
                            @endforelse
                        </tbody>
                ...
                <form action="{{ route('tim-distribusi.tahunan.export') }}" method="GET" id="exportForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Pilih "Raw Values" jika ingin mengolah data lebih lanjut di
                                Excel/CSV.</small>
                        </div>
                        <div class="mb-3">
...
@push('scripts')
    <script>
        ...
        function editData(id) {
            ...
            fetch(`${distribusiTahunanBaseUrl}/${id}/edit`)
                ...
                .catch(error => {
                    ...
                    alert('Tidak dapat memuat data Distribusi. Error: ' + error.message);
                });
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @else
                console.warn('Rute tim-distribusi.tahunan.searchPetugas tidak ada.');
            @endif
            ...
            bdb?.addEventListener('click', () => {
                ...
                newConfirmBtnBulk.addEventListener('click', (e) => {
                    e.preventDefault();
                    df.submit();
                });
                    ...
                    if (emef) {
                        ...
                        @foreach ($errors->keys() as $f)
                            ...
                            const erel = edf.querySelector(
                                `.invalid-feedback[data-field="{{ $f }}"]`); // Cari data-field
                            ...
                            // Jika tidak ada data-field, coba cari by ID (fallback)
                                ...
                                const erelById = edf.querySelector(
                                    `#edit_{{ $f }}_error`); // Misal: #edit_nama_kegiatan_error
