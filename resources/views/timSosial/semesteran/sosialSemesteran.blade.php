...
@push('styles')
    <style>
        ...
        /* [DIUBAH] CSS Grid Kustom dihapus */
        /* .modal-grid-2col { ... } */
        /* .modal-column { ... } */
        ...
        .data-table th:nth-child(3) { width: 12%; } /* BS/Responden */
        ...
        .data-table th:nth-child(7) { width: 12%; } /* Progress */
        .data-table th:nth-child(8) { width: 12%; } /* Tgl Kumpul */
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('sosial.semesteran.export',  ['jenisKegiatan' => $jenisKegiatan])}}" method="GET" id="exportForm">
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content"> <h5 class="modal-title">Ekspor Data Semesteran {{ ucwords($jenisKegiatan) }}</h5> <p class="modal-subtitle">Pilih opsi ekspor Anda</p> </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group"> <label for="exportDataRangeSem" class="form-label">Jangkauan Data</label> <select class="form-select" id="exportDataRangeSem" name="dataRange" required> <option value="all">Semua Data ({{ $listData->total() }} record)</option> <option value="current_page">Halaman Ini ({{ $listData->count() }} record)</option> </select> </div>
                        <div class="form-group"> <label for="exportDataFormatSem" class="form-label">Format Nilai Tanggal/Lainnya</label> <select class="form-select" id="exportDataFormatSem" name="dataFormat"> <option value="formatted_values" selected>Format Tampilan</option> <option value="raw_values">Nilai Asli Database</option> </select> <small class="form-text text-muted">Pilih "Raw Values" untuk olah data lanjut.</small> </div>
                        <div class="form-group"> <label for="exportExportFormatSem" class="form-label">Format File Export</label> <select class="form-select" id="exportExportFormatSem" name="exportFormat" required> <option value="excel">Excel (.xlsx)</option> <option value="csv">CSV (.csv)</option> </select> </div>
                    </div>
                    <div class="modal-footer">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group autocomplete-container">
                            ...
                            <input type="text" class="form-input @error('nama_kegiatan', 'tambahForm') is-invalid @enderror"
                                ...
                                placeholder="Ketik {{ ucwords($jenisKegiatan) }}..." required autocomplete="off">
