    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{-- Form Pencarian --}}
                <form action="{{ route('sosial.semesteran.index', ['jenisKegiatan' => $jenisKegiatan]) }}" method="GET"
                    class="mb-4">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            @forelse ($listData ?? [] as $item)
                                <tr>
                                    ...
                                    <td class="text-center"><input type="checkbox" class="form-check-input row-checkbox"
                                            value="{{ $item->id_sosial_semesteran }}"></td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <button class="btn btn-warning" data-bs-toggle="modal"
                                                ...
                                                onclick="editData({{ $item->id_sosial_semesteran }})"><i
                                                    class="bi bi-pencil-square"></i></button>
                                            <button class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleteDataModal"
                                                onclick="deleteData({{ $item->id_sosial_semesteran }})"><i
                            ...
                            @empty
                                <tr>
                                    {{-- Pesan disesuaikan --}}
                                    <td colspan="9" class="text-center">Tidak ada data {{ ucfirst($jenisKegiatan) }}
                                        yang ditemukan untuk tahun {{ $selectedTahun }}.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('sosial.semesteran.export', ['jenisKegiatan' => $jenisKegiatan]) }}"
                    method="GET">
                    @csrf
    ...
    <div class="modal fade" id="tambahDataModal" tabindex="-1" aria-labelledby="tambahDataModalLabel"
        ...
        <div class="modal-dialog">
            ...
            <form action="{{ route('sosial.semesteran.store') }}" method="POST" id="tambahForm">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="tambahDataModalLabel">Tambah Data {{ ucfirst($jenisKegiatan) }} Baru
                        </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 autocomplete-container">
                            ...
                            <input type="text" class="form-control @error('nama_kegiatan') is-invalid @enderror"
                                ...
                                placeholder="Ketik {{ ucfirst($jenisKegiatan) }}..." required autocomplete="off">
                            ...
                            <small class="form-text text-muted">Contoh: {{ ucfirst($jenisKegiatan) }} Semester 1,
                                {{ ucfirst($jenisKegiatan) }} Semester 2</small>
                        </div>
    ...
    <div class="modal fade" id="deleteDataModal" tabindex="-1" aria-labelledby="deleteDataModalLabel"
        ...
        <div class="modal-dialog">
            <form id="deleteForm" method="POST"> @csrf @method('DELETE') <div class="modal-content">
                    ...
                    <div class="modal-body" id="deleteModalBody"> Hapus data {{ ucfirst($jenisKegiatan) }} ini? </div>
