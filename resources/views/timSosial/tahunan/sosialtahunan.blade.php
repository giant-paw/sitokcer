    ...
    {{-- Alert Import Errors --}}
        ...
        <div class="page-header mb-4">
            <div class="header-content">
                 ...
                 <p class="page-subtitle">Kelola data target kegiatan tahunan tim Sosial</p>
            </div>
        </div>
                            ...
                            <tr>
                                <td colspan="9" class="empty-state"> {{-- Colspan 9 --}}
                                    ...
                                    <p class="empty-text">Tidak ada data tahunan ditemukan untuk tahun {{ $selectedTahun }}.</p>
                                     @if($search || $selectedKegiatan) <a href="{{ route('sosial.tahunan.index', ['tahun' => $selectedTahun]) }}" class="empty-link">Reset filter</a> @endif
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
                ...
                <form action="{{ route('sosial.tahunan.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info d-flex align-items-start p-3" role="alert">
                            ...
                            <div>
                                <small>
                                    <strong>PENTING:</strong> Pastikan data `nama_kegiatan` di file Excel Anda **sudah valid** dan terdaftar di Master Kegiatan untuk modul **Sosial Tahunan**.
                                </small>
                            </div>
                        </div>
                        <div class="mb-3">
                            <a href="{{ route('sosial.tahunan.downloadTemplate') }}" class="btn-action btn-secondary w-100">
    ...
    <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
             <form action="{{ route('sosial.tahunan.export') }}" method="GET" id="exportForm">
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content"> <h5 class="modal-title">Ekspor Data Sosial Tahunan</h5> <p class="modal-subtitle">Pilih opsi ekspor</p> </div>
                        <button type="button" class="modal-close" data-bs-dismiss="modal" aria-label="Close"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> </button>
                    </div>
                    <div class="modal-body">
    ...
    <div class="modal fade" id="tambahDataModal" tabindex="-1" aria-labelledby="tambahDataModalLabel" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-lg modal-dialog-centered"> 
            <form action="{{ route('sosial.tahunan.store') }}" method="POST" id="tambahForm">
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content"> <h5 class="modal-title">Tambah Data Sosial Tahunan Baru</h5> <p class="modal-subtitle">Isi form di bawah</p> </div>
                        <button type="button" class="modal-close" data-bs-dismiss="modal" aria-label="Close"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> </button>
                    </div>
                    <div class="modal-body">
...
@push('scripts')
{{-- Ini adalah skrip LENGKAP yang disesuaikan untuk 'sosial.tahunan' --}}
<script>
    /**
    ...
    // --- URL Basis BARU ---
    const sosialTahunanBaseUrl = `{{ route('sosial.tahunan.index') }}`;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @if(Route::has('sosial.tahunan.searchKegiatan'))
            const kegiatanSearchUrl = `{{ route("sosial.tahunan.searchKegiatan") }}?`; 
        ...
        @else 
            console.warn('Rute sosial.tahunan.searchKegiatan tidak ditemukan.'); 
        @endif

        @if(Route::has('sosial.tahunan.searchPetugas'))
            const petugasSearchUrl = '{{ route("sosial.tahunan.searchPetugas") }}?';
        ...
        @else 
            console.warn('Rute sosial.tahunan.searchPetugas tidak ditemukan.'); 
        @endif
        ...
        function hfc() {
            ...
            const cu = new URL('{{ route("sosial.tahunan.index") }}');
