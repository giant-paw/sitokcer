        ...
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('sosial.tahunan.export') }}" method="GET" id="exportForm">
                ...
                <div class="modal-content modern-modal">
                    ...
                    <div class="modal-body">
                        <div class="form-group"> <label for="exportDataRangeSos" class="form-label">Jangkauan Data</label> <select class="form-select" id="exportDataRangeSos" name="dataRange" required> <option value="all">Semua Data</option> <option value="current_page">Halaman Ini</option> </select> </div>
