...
{{-- [DIUBAH] Title & Header --}}
@section('title', 'Sosial Triwulanan (Seruti) - Sitokcer')
@section('header-title', 'List Target Kegiatan Triwulanan Tim Sosial')
...
@push('styles')
    <style>
        ...
        /* [DIUBAH] CSS Grid Kustom dihapus karena tidak dipakai lagi */
        /* .modal-grid-2col { ... } */
        /* .modal-column { ... } */
...
{{-- Alert Import Errors--}}
        ...
        <div class="page-header mb-4">
            <div class="header-content">
                 <h2 class="page-title">List Target Kegiatan Triwulanan (Seruti)</h2>
                 <p class="page-subtitle">Kelola data target kegiatan Seruti untuk tim Sosial</p>
            </div>
        </div>
                    ...
                    <div class="filter-group">
                     ...
                     <div class="filter-group">
                        ...
                        <select class="filter-select" id="kegiatanSelect" name="kegiatan">
                            <option value="">Semua Seruti</option>
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="empty-state">
                                    ...
                                    @if($search || !empty($selectedKegiatan)) <a href="{{ route('sosial.triwulanan.index', ['jenisKegiatan' => $jenisKegiatan, 'tahun' => $selectedTahun ?? date('Y')]) }}" class="empty-link">Reset filter</a> @endif
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="modal fade" id="tambahDataModal" tabindex="-1" aria-labelledby="tambahDataModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered"> {{-- Gunakan modal-lg --}}
            <form action="{{ route('sosial.triwulanan.store') }}" method="POST" id="tambahForm">
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content"> <h5 class="modal-title">Tambah Data Seruti</h5> <p class="modal-subtitle">Isi form di bawah</p> </div>
                        <button type="button" class="modal-close" data-bs-dismiss="modal"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> </button>
                    </div>
                    <div class="modal-body">
                        <input type="hidden" name="_form" value="tambahForm"> {{-- Error Bag --}}
                        ...
                        <div class="form-group autocomplete-container">
                            ...
                            <input type="text" class="form-input @error('nama_kegiatan', 'tambahForm') is-invalid @enderror"
                                ...
                                placeholder="Ketik Seruti-TW..." required autocomplete="off">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-input @error('BS_Responden', 'tambahForm') is-invalid @enderror" id="BS_Responden" name="BS_Responden" value="{{ old('BS_Responden') }}" required>
                           ...
                           <div class="col-md-6">
                                <div class="form-group autocomplete-container">
                                    ...
                                    <input type="text" class="form-input @error('pencacah', 'tambahForm') is-invalid @enderror" id="pencacah" name="pencacah" value="{{ old('pencacah') }}" required autocomplete="off">
                           ...
                           <div class="col-md-6">
                                <div class="form-group autocomplete-container">
                                    ...
                                    <input type="text" class="form-input @error('pengawas', 'tambahForm') is-invalid @enderror" id="pengawas" name="pengawas" value="{{ old('pengawas') }}" required autocomplete="off">
                           ...
                           <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-input @error('target_penyelesaian', 'tambahForm') is-invalid @enderror" id="target_penyelesaian" name="target_penyelesaian" value="{{ old('target_penyelesaian') }}" required>
                           ...
                           <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-input @error('tanggal_pengumpulan', 'tambahForm') is-invalid @enderror" id="tanggal_pengumpulan" name="tanggal_pengumpulan" value="{{ old('tanggal_pengumpulan') }}">
    ...
    <div class="modal fade" id="editDataModal" tabindex="-1" aria-labelledby="editDataModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered"> {{-- Gunakan modal-lg --}}
            <form id="editForm" method="POST">
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content"> <h5 class="modal-title">Edit Data Seruti</h5> <p class="modal-subtitle">Perbarui informasi data</p> </div>
                        <button type="button" class="modal-close" data-bs-dismiss="modal"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> </button>
                    </div>
                    <div class="modal-body">
                         {{-- **** [DIUBAH] Terapkan layout Bootstrap Grid **** --}}
        ...
        function editData(id) {
            ...
            fetch(`${sosialTriwulananBaseUrl}/${id}/edit`)
                ...
                .then(data => {
                    ...
                    document.getElementById('edit_flag_progress').value = data.flag_progress || 'Belum Selesai'; // [FIX] Default
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // --- Init Autocomplete ---
             @if (Route::has('sosial.triwulanan.searchKegiatan'))
                 const kegiatanSearchUrl = '{{ route('sosial.triwulanan.searchKegiatan') }}'; // [FIX] Hapus '?'
             ...
             @else console.warn('Rute sosial.triwulanan.searchKegiatan tidak ditemukan.'); @endif

             @if (Route::has('sosial.triwulanan.searchPetugas'))
                 const petugasSearchUrl = '{{ route('sosial.triwulanan.searchPetugas') }}'; // [FIX] Hapus '?'
             ...
             @else console.warn('Rute sosial.triwulanan.searchPetugas tidak ditemukan.'); @endif
            ...
            function hfc() {
                const cu = new URL(window.location.href); const p = cu.searchParams;
             ...
             @if (session('error_modal') == 'editDataModal' && $errors->editForm->any())
                 ...
                 if (eid_fb) {
                     ...
                     if (emef) {
                         ...
                         edf.action = `${sosialTriwulananBaseUrl}/${eid_fb}`;
