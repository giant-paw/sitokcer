...
@section('title', 'Dashboard Tim NWA')
@section('header-title', 'Dashboard Tim NWA')
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-7">
            <h3 class="mb-1 fw-bold">Dashboard Tim NWA</h3>
            <p class="text-muted mb-0">Monitoring dan evaluasi kegiatan NWA tahun {{ $selectedTahun }}</p>
        </div>
        <div class="col-md-3">
            <form action="{{ route('dashboard.nwa.index') }}" method="GET" id="filterTahunForm">
    ...
    {{-- Detail per Periode (2 Kartu) --}}
    <div class="row g-4 justify-content-center">
        {{-- Kegiatan Tahunan --}}
        <div class="col-md-6 col-lg-6"> {{-- Menggunakan col-lg-6 agar sejajar --}}
            <a href="{{ route('dashboard.nwa.tahunan', ['tahun' => $selectedTahun]) }}" class="card-clickable">
        ...
        {{-- Kegiatan Triwulanan --}}
        <div class="col-md-6 col-lg-6"> {{-- Menggunakan col-lg-6 agar sejajar --}}
            <a href="{{ route('dashboard.nwa.triwulanan', ['tahun' => $selectedTahun]) }}" class="card-clickable">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-3">
