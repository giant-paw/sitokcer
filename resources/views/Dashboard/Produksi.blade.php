...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-7">
            ...
            <h3 class="mb-1 fw-bold">Dashboard Tim Produksi</h3>
            <p class="text-muted mb-0">Monitoring dan evaluasi kegiatan produksi tahun {{ $selectedTahun }}</p>
        </div>
        <div class="col-md-3">
            {{-- [PERUBAHAN] Route diubah --}}
            <form action="{{ route('dashboard.produksi.index') }}" method="GET" id="filterTahunForm">
    ...
    {{-- Ringkasan Umum (Sama persis, tidak perlu diubah) --}}
    <div class="row mb-4">
        <div class="col-12">
    ...
    {{-- [PERUBAHAN] Detail per Periode (4 Kartu) --}}
    <div class="row g-4">
        {{-- Kegiatan Tahunan --}}
        <div class="col-md-6 col-lg-3"> {{-- Diubah ke col-lg-3 --}}
            <a href="{{ route('dashboard.produksi.tahunan', ['tahun' => $selectedTahun]) }}" class="card-clickable">
        ...
        {{-- [BARU] Kegiatan Caturwulan --}}
        <div class="col-md-6 col-lg-3"> {{-- Diubah ke col-lg-3 --}}
            <a href="{{ route('dashboard.produksi.caturwulan', ['tahun' => $selectedTahun]) }}" class="card-clickable">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-3">
                            <div class="bg-light rounded p-2 me-3"><i class="bi bi-calendar4-week text-primary fs-4"></i></div>
                            <div>
                                <h6 class="mb-0 fw-semibold">Kegiatan Caturwulan</h6>
                                <small class="text-muted">Periode 4 Bulan</small>
                            </div>
                        </div>
                        <div class="mb-3">
                            @php
                                $progressCaturwulan = ($caturwulan->total ?? 0) > 0 ? round((($caturwulan->selesai ?? 0) / $caturwulan->total) * 100, 1) : 0;
                            @endphp
                            <div class="d-flex justify-content-between mb-2">
                                <small class="text-muted">Progress</small>
                                <small class="fw-semibold">{{ $progressCaturwulan }}%</small>
                            </div>
                            <div class="progress" style="height: 6px;">
                                <div class="progress-bar bg-primary" style="width: {{ $progressCaturwulan }}%"></div>
                            </div>
                        </div>
                        <div class="row g-2">
                            <div class="col-4"><div class="p-3 bg-light rounded"><small class="text-muted d-block mb-1">Total</small><h5 class="mb-0 fw-bold">{{ $caturwulan->total ?? 0 }}</h5></div></div>
                            <div class="col-4"><div class="p-3 bg-light rounded"><small class="text-muted d-block mb-1">Selesai</small><h5 class="mb-0 fw-bold text-success">{{ $caturwulan->selesai ?? 0 }}</h5></div></div>
                            <div class="col-4"><div class="p-3 bg-light rounded"><small class="text-muted d-block mb-1">Belum</small><h5 class="mb-0 fw-bold text-danger">{{ $caturwulan->belum_selesai ?? 0 }}</h5></div></div>
                        </div>
                    </div>
                </div>
            </a>
        ...
        {{-- Kegiatan Triwulanan --}}
        <div class="col-md-6 col-lg-3"> {{-- Diubah ke col-lg-3 --}}
            <a href="{{ route('dashboard.produksi.triwulanan', ['tahun' => $selectedTahun]) }}" class="card-clickable">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-3">
        ...
        {{-- [BARU] Kegiatan Bulanan --}}
        <div class="col-md-6 col-lg-3"> {{-- Diubah ke col-lg-3 --}}
            <a href="{{ route('dashboard.produksi.bulanan', ['tahun' => $selectedTahun]) }}" class="card-clickable">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-3">
...
<style>
    /* Style sama persis, tidak perlu diubah */
