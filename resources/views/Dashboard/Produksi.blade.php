...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Monitoring dan evaluasi kegiatan produksi</p>
                </div>
                <div class="text-end">
    ...
    <div class="row g-4">
        ...
        {{-- Kegiatan Caturwulanan --}}
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                        <div class="bg-light rounded p-2 me-3">
                            <i class="bi bi-calendar4-range text-primary fs-4"></i>
                        </div>
                        <div>
                            <h6 class="mb-0 fw-semibold">Kegiatan Caturwulanan</h6>
                    ...
                    <div class="mb-3">
                        @php
                            $progressCaturwulanan = ($caturwulanan->total ?? 0) > 0 ? round((($caturwulanan->selesai ?? 0) / $caturwulanan->total) * 100, 1) : 0;
                        @endphp
                        <div class="d-flex justify-content-between mb-2">
                            <small class="text-muted">Progress</small>
                            <small class="fw-semibold">{{ $progressCaturwulanan }}%</small>
                        </div>
                        <div class="progress" style="height: 6px;">
                            <div class="progress-bar bg-primary" style="width: {{ $progressCaturwulanan }}%"></div>
                        </div>
                    </div>
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <div class="p-3 bg-light rounded">
                                <small class="text-muted d-block mb-1">Total</small>
                                <h5 class="mb-0 fw-bold">{{ $caturwulanan->total ?? 0 }}</h5>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-3 bg-light rounded">
                                <small class="text-muted d-block mb-1">Selesai</small>
                                <h5 class="mb-0 fw-bold text-success">{{ $caturwulanan->selesai ?? 0 }}</h5>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-3 bg-light rounded">
                                <small class="text-muted d-block mb-1">Proses</small>
                                <h5 class="mb-0 fw-bold text-warning">{{ $caturwulanan->proses ?? 0 }}</h5>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-3 bg-light rounded">
                                <small class="text-muted d-block mb-1">Belum Mulai</small>
                                <h5 class="mb-0 fw-bold text-secondary">{{ $caturwulanan->belum_mulai ?? 0 }}</h5>
                            </div>
                        </div>
                    </div>
                </div>
