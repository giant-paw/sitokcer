...
@push('styles')
    <style>
        ...
        .card.elegant-card {
            border: none;
            border-radius: 12px;
            /* Lebih rounded dari default global */
            box-shadow: 0 8px 24px rgba(0, 0, 0, 0.05);
            background-color: var(--card-bg, #ffffff);
            /* Pakai var global */
            overflow: visible;
            /* Biarkan overflow visible */
            margin-bottom: var(--spacing-lg, 1.5rem);
            /* Gunakan spacing global */
        }
    ...
    <div class="container-fluid px-4 py-4"> {{-- Gunakan padding global --}}
        ...
        <div class="card elegant-card filter-card">
            <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <form method="get" class="search-form mb-0 flex-grow-1" id="searchForm"
                    style="min-width: 280px; max-width: 400px;">
                    <input type="text" id="searchInput" class="search-input" name="q" value="{{ $q ?? '' }}"
                        placeholder="Cari nama pencacah..." autocomplete="off">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" href="{{ route('rekapitulasi.pencacah.printAll', ['q' => $q]) }}"
                                target="_blank">
                                Cetak Semua
                            </a>
                        </li>
                            ...
                            @forelse($rekapPencacah as $index => $pencacah)
                                <tr>
                                    ...
                                    <td class="td-checkbox">
                                        <input class="table-checkbox row-checkbox" type="checkbox" name="pencacah_ids[]"
                                            value="{{ $pencacah->nama_pencacah }}">
                                    </td>
                                    <td class="text-center fw-bold text-secondary">{{ $rekapPencacah->firstItem() + $index }}
                                    </td>
                                    ...
                                    <td class="td-action">
                                        <div class="action-buttons"> {{-- Tambahkan wrapper jika ada >1 tombol --}}
                                            <button type="button" class="btn-icon btn-icon-view" {{-- Ubah ke button style icon
                                                --}} title="Lihat Detail" data-bs-toggle="modal" data-bs-target="#detailModal"
                            ...
                            @empty
                                ...
                                <tr>
                                    <td colspan="5" class="empty-state">
                                        ...
                                        @if($q)
                                            <a href="{{ route('rekapitulasi.pencacah.index') }}" class="empty-link">Reset
                                                pencarian</a>
                                        @endif
                                    </td>
                                </tr>
                ...
                @if ($rekapPencacah->hasPages())
                    <div class="table-footer">
                        ...
                        <div class="footer-info">
                            Displaying {{ $rekapPencacah->firstItem() ?? 0 }} - {{ $rekapPencacah->lastItem() ?? 0 }} of
                            {{ $rekapPencacah->total() }}
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered table-striped mb-0">
                            ...
                            <tbody id="detailKegiatanBody">
                                ...
                                <tr>
                                    <td colspan="2" class="text-center p-5"><span
                                            class="spinner-border spinner-border-sm"></span> Memuat...</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
