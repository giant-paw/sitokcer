...
{{-- [DIUBAH] Judul dan header disesuaikan --}}
@section('title', 'NWA Tahunan - Sitokcer')
...
@section('content')
    ...
    <div class="container-fluid px-4 py-4">
            ...
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                ...
                <ul class="mb-0">
                    @foreach (session('import_errors') as $error)
                        <li>{{ $error['error'] }} (Baris: {{ $error['row'] ?? '?' }})</li>
                    @endforeach
                </ul>
                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
            </div>
        ...
        {{-- Duplikat Alert Error (Hapus jika tidak perlu, tapi Anda punya dua) --}}
        {{-- @if (session('import_errors'))
        ...
        <div class="page-header mb-4">
            <div class="header-content">
                ...
                <h2 class="page-title">List Target Kegiatan Tahunan NWA</h2>
        ...
        <div class="data-card">
            ...
            <div class="toolbar">
                ...
                <div class="toolbar-right">
                    ...
                    {{-- [DIUBAH] Route action disesuaikan --}}
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        @forelse ($listData ?? [] as $item)
                            <tr>
                                {{-- [DIUBAH] Value checkbox menggunakan id_nwa --}}
                                ...
                                <td>
                                    @php
                                        ...
                                        // Sesuaikan badge class berdasarkan nilai flag
                                ...
                                <td class="td-action">
                                    <div class="action-buttons">
                                        {{-- [DIUBAH] onclick editData menggunakan id_nwa --}}
                                        ...
                                        {{-- [DIUBAH] onclick deleteData menggunakan id_nwa --}}
                            ...
                            <tr>
                                <td colspan="9" class="empty-state">
                                    ...
                                    @if(request('search') || request('kegiatan'))
                                        {{-- [DIUBAH] Route reset filter disesuaikan --}}
                                        <a href="{{ route('nwa.tahunan.index', ['tahun' => $selectedTahun ?? date('Y')]) }}" class="empty-link">Reset filter</a>
                                    @endif
                                </td>
                            </tr>
                        @endforelse
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('nwa.tahunan.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            {{-- [DIUBAH] Route download template disesuaikan --}}
    ...
    <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <form action="{{ route('nwa.tahunan.export') }}" method="GET" id="exportForm">
                {{-- CSRF tidak perlu untuk GET request --}}
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content">
                            {{-- [DIUBAH] Title modal disesuaikan --}}
                    ...
                    <div class="modal-body">
                        ...
                        {{-- [DIHAPUS] Opsi Data Format dihilangkan sesuai controller NWA --}}
                        {{-- <div class="form-group">
...
@push('scripts')
    <script>
        ...
        function initAutocomplete(inputId, suggestionsId, searchUrl) {
            ...
            if (!suggestionsContainer) return; // Tambahan guard
            let debounceTimer;
            ...
            document.addEventListener('click', (e) => {
                // Pastikan suggestionsContainer ada sebelum mencoba mengubah innerHTML
        ...
        function editData(id) {
            ...
            if (!editForm) return; // Tambahan guard

            // [DIUBAH] URL disesuaikan
            ...
            fetch(`${nwaTahunanBaseUrl}/${id}/edit`)
                ...
                .then(data => {
                    ...
                    document.getElementById('edit_flag_progress').value = data.flag_progress || 'Belum Selesai'; // Default jika null
        ...
        function deleteData(id) {
            ...
            if (!deleteForm) return; // Tambahan guard
            ...
            if (!confirmBtn) return; // Guard

            // Ganti tombol untuk hapus listener lama
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // --- LOGIKA AUTO HIDE ALERT IMPORT ERROR ---
            const importAlert = document.getElementById('importErrorAlert');
            if (importAlert) {
                setTimeout(function() {
                    try {
                        if (window.jQuery) {
                            $(importAlert).fadeOut('slow');
                        } else {
                            // Fallback JS murni
                            importAlert.style.transition = 'opacity 1s';
                            importAlert.style.opacity = '0';
                            setTimeout(() => importAlert.remove(), 1000);
                        }
                    } catch (e) {
                         // Fallback jika jQuery error
                        console.warn("jQuery fadeOut error:", e);
                        importAlert.style.transition = 'opacity 1s';
                        importAlert.style.opacity = '0';
                        setTimeout(() => importAlert.remove(), 1000);
                    }
            ...
            // --- AKHIR LOGIKA AUTO HIDE ---


            // --- Init Autocomplete ---
            // Pastikan rute 'master.kegiatan.search' ada
            ...
            // [DIUBAH] Route searchPetugas disesuaikan
            // Pastikan rute 'nwa.tahunan.searchPetugas' ada
            ...
            if (bdb) {
                bdb.addEventListener('click', () => {
                    ...
                    // [DIUBAH] Route bulkDelete disesuaikan
                    ...
                    if (mi) {
                        ...
                        // Jika @method('DELETE') tidak ada, tambahkan _method POST
            ...
            function hfc() {
                ...
                p.set('page', 1); // Reset ke halaman 1 saat filter berubah
            ...
            @if (session('error_modal') == 'editDataModal' && $errors->any() && session('edit_id'))
                ...
                if (eid) {
                    ...
                    if (editForm) {
                        ...
                        // Tampilkan error validasi di modal edit
            ...
            @if (session('success') && session('auto_hide'))
                ...
                // Pastikan alert bukan di dalam modal
