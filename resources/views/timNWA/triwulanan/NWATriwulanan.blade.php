                            ...
                            @forelse ($listData ?? [] as $item)
                                <tr>
                                    <td class="text-center"><input type="checkbox" class="form-check-input row-checkbox"
                                            value="{{ $item->id_nwa_triwulanan }}"></td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm">
                                            <button class="btn btn-warning" data-bs-toggle="modal"
                                                ...
                                                onclick="editData({{ $item->id_nwa_triwulanan }})"><i
                                                    class="bi bi-pencil-square"></i></button>
                                            <button class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleteDataModal"
                                                onclick="deleteData({{ $item->id_nwa_triwulanan }})"><i
    ...
    <div class="modal fade" id="tambahDataModal" tabindex="-1" aria-labelledby="tambahDataModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <form action="{{ route('nwa.triwulanan.store') }}" method="POST" id="tambahForm">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Data NWA Triwulanan</h5> <button type="button" class="btn-close"
...
@push('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (autocompleteUrls.petugas) {
                initAutocomplete('pencacah', 'pencacah-suggestions', autocompleteUrls.petugas);
                initAutocomplete('pengawas', 'pengawas-suggestions', autocompleteUrls.petugas);
                initAutocomplete('edit_pencacah', 'edit-pencacah-suggestions', autocompleteUrls.petugas);
                initAutocomplete('edit_pengawas', 'edit-pengawas-suggestions', autocompleteUrls.petugas);
            } else {
                console.warn('Rute master.petugas.search tidak ada.');
            }
