...
{{-- Judul Disesuaikan --}}
@section('title', strtoupper(str_replace('-', ' ', $jenisKegiatan)) . ' - NWA Triwulan - Sitokcer')
@section('header-title', 'List Target Kegiatan: ' . strtoupper(str_replace('-', ' ', $jenisKegiatan)))

@push('styles')
    <style>
        /* (Style dari modul lain) */
        ...
        .modern-modal .invalid-feedback { display: none; }
        .modern-modal .is-invalid ~ .invalid-feedback { display: block; }
    </style>
@endpush
...
@section('content')
    ...
    {{-- Alert Import Errors --}}
        ...
        <div class="page-header mb-4">
            <div class="header-content">
                <h2 class="page-title">List Target Kegiatan Triwulan: {{ strtoupper(str_replace('-', ' ', $jenisKegiatan)) }}</h2>
                <p class="page-subtitle">Kelola data target kegiatan {{ $jenisKegiatan }} tim NWA</p>
            </div>
        </div>
        ...
        <div class="data-card">
            ...
            <div class="toolbar">
                ...
                <div class="toolbar-right">
                    ...
                    <form action="{{ route('nwa.triwulanan.index', ['jenisKegiatan' => $jenisKegiatan]) }}" method="GET" class="search-form">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        @forelse ($listData as $item)
                            <tr>
                                <td class="td-checkbox"><input type="checkbox" class="table-checkbox row-checkbox" value="{{ $item->id_nwa_triwulanan }}"></td>
                                ...
                                <td class="td-action">
                                    <div class="action-buttons">
                                        <button class="btn-icon btn-icon-edit" title="Edit" data-bs-toggle="modal" data-bs-target="#editDataModal" onclick="editData({{ $item->id_nwa_triwulanan }})"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg> </button>
                                        <button class="btn-icon btn-icon-delete" title="Hapus" data-bs-toggle="modal" data-bs-target="#deleteDataModal" onclick="deleteData({{ $item->id_nwa_triwulanan }})"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> </button>
                                    </div>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="9" class="empty-state">
                                    ...
                                    <p class="empty-text">Tidak ada data {{ strtoupper(str_replace('-', ' ', $jenisKegiatan)) }} ditemukan untuk tahun {{ $selectedTahun }}.</p>
                                    @if($search || $selectedKegiatan) <a href="{{ route('nwa.triwulanan.index', ['jenisKegiatan' => $jenisKegiatan, 'tahun' => $selectedTahun]) }}" class="empty-link">Reset filter</a> @endif
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
                ...
                <form action="{{ route('nwa.triwulanan.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info d-flex align-items-start p-3" role="alert">
                            ...
                            <div>
                                <small>
                                    <strong>PENTING:</strong> Pastikan data `nama_kegiatan` di file Excel Anda **sudah valid** dan terdaftar di Master Kegiatan untuk modul **NWA Triwulanan**.
                                </small>
                            </div>
                        </div>
                        <div class="mb-3">
                            <a href="{{ route('nwa.triwulanan.downloadTemplate') }}" class="btn-action btn-secondary w-100">
    ...
    <div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('nwa.triwulanan.export', ['jenisKegiatan' => $jenisKegiatan]) }}" method="GET" id="exportForm">
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content"> <h5 class="modal-title">Ekspor Data Triwulan {{ strtoupper(str_replace('-', ' ', $jenisKegiatan)) }}</h5> <p class="modal-subtitle">Pilih opsi ekspor</p> </div>
                        <button type="button" class="modal-close" data-bs-dismiss="modal" aria-label="Close"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> </button>
                    </div>
                    <div class="modal-body">
    ...
    <div class="modal fade" id="tambahDataModal" tabindex="-1" aria-labelledby="tambahDataModalLabel" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-lg modal-dialog-centered"> 
            <form action="{{ route('nwa.triwulanan.store') }}" method="POST" id="tambahForm">
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content"> <h5 class="modal-title">Tambah Data {{ strtoupper(str_replace('-', ' ', $jenisKegiatan)) }} Baru</h5> <p class="modal-subtitle">Isi form di bawah</p> </div>
                        <button type="button" class="modal-close" data-bs-dismiss="modal" aria-label="Close"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> </button>
                    </div>
                    <div class="modal-body">
    ...
    <div class="modal fade" id="editDataModal" tabindex="-1" aria-labelledby="editDataModalLabel" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-lg modal-dialog-centered"> 
            <form id="editForm" method="POST"> 
                ...
                <div class="modal-content modern-modal">
                    <div class="modal-header">
                        <div class="modal-header-content"> <h5 class="modal-title">Edit Data {{ strtoupper(str_replace('-', ' ', $jenisKegiatan)) }}</h5> <p class="modal-subtitle">Perbarui informasi data</p> </div>
                        <button type="button" class="modal-close" data-bs-dismiss="modal" aria-label="Close"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> </button>
                    </div>
                    <div class="modal-body">
...
{{-- 
====================================================================
== [PERBAIKAN] JAVASCRIPT INI DIUBAH UNTUK 'nwa.tahunan'
====================================================================
--}}
<script>
    /**
    ...
    // --- [PERBAIKAN] URL Basis untuk TIM NWA ---
    const tahunanRootUrl = `{{ url('nwa/tahunan') }}`; // URL dasar: .../nwa/tahunan
    const tahunanPageUrl = `{{ route('nwa.tahunan.index') }}`;
    ...
    function editData(id) {
        ...
        editForm.action = `${tahunanRootUrl}/${id}`; // Hasil: .../nwa/tahunan/123
        ...
        fetch(`${tahunanRootUrl}/${id}/edit`) // Hasil: .../nwa/tahunan/123/edit
            .then(response => { 
    ...
    function deleteData(id) {
        ...
        deleteForm.action = `${tahunanRootUrl}/${id}`; // Hasil: .../nwa/tahunan/123
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @if(Route::has('nwa.tahunan.searchKegiatan'))
            const kegiatanSearchUrl = `{{ route("nwa.tahunan.searchKegiatan") }}?`; 
        ...
        @else 
            console.warn('Rute nwa.tahunan.searchKegiatan tidak ditemukan.'); 
        @endif
        ...
        @else 
            console.warn('Rute nwa.tahunan.searchPetugas tidak ditemukan.'); 
        @endif
        ...
        function hfc() {
            const cu = new URL(tahunanRootUrl); // URL Halaman saat ini
